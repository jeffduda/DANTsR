...
#include "polylineBSplineSmoothing.h"


template< class InputMeshType, class OutputMeshType >
SEXP polylineBSplineSmoothing( SEXP r_mesh )
{
  Rcpp::Rcout << "itkPolyLineMeshBSplineSmoothingFilter<MeshType,MeshType>()" << std::endl;
  ...
  using FilterType = itk::PolyLineMeshBSplineSmoothingFilter<InputMeshType, OutputMeshType>;
...
RcppExport SEXP polylineBSplineSmoothing( SEXP r_mesh )
{
try
{
  Rcpp::Rcout << "polylineBSplineSmoothing()" << std::endl;
  ...
  if( pixeltype == "double" )
    ...
    if ( dimension == 1 )
      ...
      return  polylineBSplineSmoothing< InputMeshType, OutputMeshType >( r_mesh);
      }
    else if ( dimension == 2 )
      {
