...
extern SEXP antsrMesh_GetPointData(SEXP, SEXP);
...
extern SEXP extractMesh(SEXP, SEXP, SEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"antsrMesh_GetPointData",        (DL_FUNC) &antsrMesh_GetPointData,          2},
    ...
    {"extractMesh",                   (DL_FUNC) &extractMesh,                     3},
