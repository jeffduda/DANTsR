...
=========================================================================*/
#ifndef __itkPreservationOfPrincipalDirectionTensorReorientationImageFilter2_h
#define __itkPreservationOfPrincipalDirectionTensorReorientationImageFilter2_h
...
class PreservationOfPrincipalDirectionTensorReorientationImageFilter2 :
...
public:
  ...
  typedef typename VectorType::ValueType            PrecisionType;

  typedef itk::DisplacementFieldTransform<PrecisionType, 3> DisplacementFieldTransformType;
  ...
  typedef PreservationOfPrincipalDirectionTensorReorientationImageFilter2 Self;
  ...
  itkTypeMacro(PreservationOfPrincipalDirectionTensorReorientationImageFilter2, ImageToImageFilter);
...
protected:
  PreservationOfPrincipalDirectionTensorReorientationImageFilter2();
  ~PreservationOfPrincipalDirectionTensorReorientationImageFilter2() override = default;

  void PrintSelf(std::ostream& os, Indent indent) const override;

  /** PreservationOfPrincipalDirectionTensorReorientationImageFilter2 can be implemented as a multithreaded filter.
  ...
  {
    typedef itk::Vector<RealType, ImageDimension> locVectorType;
...
private:
  PreservationOfPrincipalDirectionTensorReorientationImageFilter2(const Self &) = delete;
...
#include "itkPreservationOfPrincipalDirectionTensorReorientationImageFilter2.cxx"
#endif
