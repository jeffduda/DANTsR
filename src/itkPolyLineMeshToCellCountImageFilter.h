 ...
 *
 *=========================================================================*/
#ifndef itkPolyLineMeshToCellCountImageFilter_h
#define itkPolyLineMeshToCellCountImageFilter_h
...
/** \class PolyLineMeshToCellCountImageFilter
 *
...
class ITK_TEMPLATE_EXPORT PolyLineMeshToCellCountImageFilter:public ImageSource< TOutputImage >
{
public:
  ITK_DISALLOW_COPY_AND_ASSIGN(PolyLineMeshToCellCountImageFilter);

  /** Standard class type aliases. */
  using Self = PolyLineMeshToCellCountImageFilter;
  ...
  itkTypeMacro(PolyLineMeshToCellCountImageFilter, ImageSource);
...
protected:
  ...
  ~PolyLineMeshToCellCountImageFilter() override;
...
#include "itkPolyLineMeshToCellCountImageFilter.hxx"
#endif
