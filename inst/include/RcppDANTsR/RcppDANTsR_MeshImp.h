...
template <> inline
SEXP wrap( const itk::Mesh< double, 1 >::Pointer & mesh )
{
  typedef itk::Mesh<double,1>             MeshType;
...
template <> inline
SEXP wrap( const itk::Mesh< float, 1 >::Pointer & mesh )
{
  typedef itk::Mesh<float,1>             MeshType;
  typedef MeshType::Pointer               MeshPointerType;
  typedef Rcpp::XPtr<MeshPointerType>   XPtrType;
...
template <> inline
itk::Mesh< double,1 >::Pointer as( SEXP mesh )
{
...
template <> inline
itk::Mesh< float,1 >::Pointer as( SEXP mesh )
{
  const unsigned int Dim = 1;
